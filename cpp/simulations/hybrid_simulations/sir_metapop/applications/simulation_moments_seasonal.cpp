...
int main()
{
    auto config                = Config::sirs::get_config(Config::sirs::SeasonalConfigType::Config1);
    ...
    // INPUT - SIR/SIRS
    std::string save_file = Config::SAVE_DIR + "Moments/SIRS_seasonal/";
    ...
    // INPUT - SIR/SIRS
    std::string init_dir = Config::SAVE_DIR + "SMM/SIRS_seasonal/" + config.name + "/";
