...
// void run_moments_sim(std::string save_dir, const Config::sir::Config& config,
...
int main()
{
    auto config                = Config::sirs::get_config(Config::sirs::ConfigType::Config4regionsTransmNoExchange);
    ...
    std::string save_file = Config::SAVE_DIR + "Moments/SIRS/";
    ...
    std::string init_dir = Config::SAVE_DIR + "SMM/SIRS/" + config.name + "/";
