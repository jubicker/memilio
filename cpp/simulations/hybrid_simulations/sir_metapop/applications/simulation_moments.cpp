...
int main()
{
    auto config                = Config::sir::get_config(Config::sir::ConfigType::Config4regionsk2);
    ...
    // INPUT - SIR/SIRS
    std::string save_file = Config::SAVE_DIR + "Moments/SIR/";
    ...
    // INPUT - SIR/SIRS
    std::string init_dir = Config::SAVE_DIR + "SMM/SIR/" + config.name + "/";
