...
compartment_colors = {
    ...
    "I": [colors["dark red"], colors["red"], colors["orange"], colors["rose"], colors["purple"]],
    "R": [colors["middle green"], colors["teal"], colors["dark green"], colors["light green"], colors["light teal"]],
}
