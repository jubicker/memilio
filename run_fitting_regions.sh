...
#SBATCH -t 1-00:00:00
#SBATCH --exclusive
#SBATCH --output=%A_fitting_region.out
#SBATCH --error=%A_fitting_region.err
#SBATCH --account=loki
#SBATCH --threads-per-core=1

module load Python/3.13.5

cd /p/project1/loki/bicker1/memilio/virt_env/bin
. ./activate
...
srun --cpu-bind=core --cpus-per-task=128 python /p/project1/loki/bicker1/memilio/cpp/simulations/hybrid_simulations/sir_metapop/bindings/run_fitting_germany_regions.py
