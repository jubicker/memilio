...
#SBATCH -t 1-00:00:00
#SBATCH --exclusive
#SBATCH --output=%A_fitting.out
#SBATCH --error=%A_fitting.err
#SBATCH --account=loki
...
srun --cpu-bind=core --cpus-per-task=128 python /p/project1/loki/bicker1/memilio/cpp/simulations/hybrid_simulations/sir_metapop/bindings/run_fitting_germany.py
